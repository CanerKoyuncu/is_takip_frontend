...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1287: x0 => x0.remove(),
      _1288: x0 => x0.click(),
      _1291: (x0,x1) => x0.getContext(x1),
      _1297: () => new FileReader(),
      _1298: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1303: x0 => globalThis.URL.revokeObjectURL(x0),
      _1304: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      _1305: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      _1306: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1306(f,arguments.length,x0) }),
      _1307: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      ...
      _1328: () => typeof dartUseDateNowForTicks !== "undefined",
      _1329: () => 1000 * performance.now(),
      _1330: () => Date.now(),
      _1331: () => {
      ...
      _1333: () => new WeakMap(),
      _1334: (map, o) => map.get(o),
      _1335: (map, o, v) => map.set(o, v),
      _1336: x0 => new WeakRef(x0),
      _1337: x0 => x0.deref(),
      _1344: () => globalThis.WeakRef,
      _1348: s => JSON.stringify(s),
      _1349: s => printToConsole(s),
      _1350: (o, p, r) => o.replaceAll(p, () => r),
      _1351: (o, p, r) => o.replace(p, () => r),
      _1352: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1353: s => s.toUpperCase(),
      _1354: s => s.trim(),
      _1355: s => s.trimLeft(),
      _1356: s => s.trimRight(),
      _1357: (string, times) => string.repeat(times),
      _1358: Function.prototype.call.bind(String.prototype.indexOf),
      _1359: (s, p, i) => s.lastIndexOf(p, i),
      _1360: (string, token) => string.split(token),
      _1361: Object.is,
      _1362: o => o instanceof Array,
      _1363: (a, i) => a.push(i),
      _1367: a => a.pop(),
      _1368: (a, i) => a.splice(i, 1),
      _1369: (a, s) => a.join(s),
      _1370: (a, s, e) => a.slice(s, e),
      _1372: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1373: a => a.length,
      _1375: (a, i) => a[i],
      _1376: (a, i, v) => a[i] = v,
      _1378: o => {
      ...
      _1379: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1381: o => o instanceof Uint8Array,
      _1382: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1383: o => o instanceof Int8Array,
      _1384: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1385: o => o instanceof Uint8ClampedArray,
      _1386: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1387: o => o instanceof Uint16Array,
      _1388: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1389: o => o instanceof Int16Array,
      _1390: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1391: o => o instanceof Uint32Array,
      _1392: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1393: o => o instanceof Int32Array,
      _1394: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1396: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1397: o => o instanceof Float32Array,
      _1398: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1399: o => o instanceof Float64Array,
      _1400: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1401: (t, s) => t.set(s),
      _1402: l => new DataView(new ArrayBuffer(l)),
      _1403: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1404: o => o.byteLength,
      _1405: o => o.buffer,
      _1406: o => o.byteOffset,
      _1407: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1408: (b, o) => new DataView(b, o),
      _1409: (b, o, l) => new DataView(b, o, l),
      _1410: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1411: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1412: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1413: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1414: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1415: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1416: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1417: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1418: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1419: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1420: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1421: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1424: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1425: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1426: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1427: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1428: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1429: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1442: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1443: (handle) => clearTimeout(handle),
      _1444: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1445: (handle) => clearInterval(handle),
      _1446: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1447: () => Date.now(),
      _1452: o => Object.keys(o),
      _1453: () => new XMLHttpRequest(),
      _1454: (x0,x1,x2) => x0.open(x1,x2),
      _1455: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1456: x0 => x0.abort(),
      _1457: (x0,x1) => x0.send(x1),
      _1458: x0 => x0.send(),
      _1459: x0 => x0.getAllResponseHeaders(),
      _1460: () => new AbortController(),
      _1461: x0 => x0.abort(),
      _1462: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1463: (x0,x1) => globalThis.fetch(x0,x1),
      ...
      _1467: x0 => x0.getReader(),
      _1468: x0 => x0.cancel(),
      _1469: x0 => x0.read(),
      _1471: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      ...
      _1479: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1480: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1487: (x0,x1) => x0.key(x1),
      ...
      _1508: (x0,x1) => x0.exec(x1),
      _1509: (x0,x1) => x0.test(x1),
      _1510: x0 => x0.pop(),
      _1512: o => o === undefined,
      _1514: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1516: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1517: o => o instanceof RegExp,
      _1518: (l, r) => l === r,
      _1519: o => o,
      _1520: o => o,
      _1521: o => o,
      ...
      _1540: o => [o],
      _1541: (o0, o1) => [o0, o1],
      _1542: (o0, o1, o2) => [o0, o1, o2],
      _1543: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1558: x0 => x0.groups,
      _1559: x0 => x0.flags,
      _1560: x0 => x0.multiline,
      _1561: x0 => x0.ignoreCase,
      _1562: x0 => x0.unicode,
      _1563: x0 => x0.dotAll,
      _1564: (x0,x1) => { x0.lastIndex = x1 },
      _1565: (o, p) => p in o,
      _1566: (o, p) => o[p],
      _1569: x0 => x0.random(),
      ...
      _1574: Function.prototype.call.bind(BigInt.prototype.toString),
      _1575: Function.prototype.call.bind(Number.prototype.toString),
      _1576: (d, digits) => d.toFixed(digits),
      _1660: x0 => x0.readyState,
      _1662: (x0,x1) => { x0.timeout = x1 },
      _1664: (x0,x1) => { x0.withCredentials = x1 },
      _1665: x0 => x0.upload,
      _1666: x0 => x0.responseURL,
      _1667: x0 => x0.status,
      _1668: x0 => x0.statusText,
      _1670: (x0,x1) => { x0.responseType = x1 },
      _1671: x0 => x0.response,
      _1683: x0 => x0.loaded,
      _1684: x0 => x0.total,
      _1760: (x0,x1) => { x0.oncancel = x1 },
      _1766: (x0,x1) => { x0.onchange = x1 },
      _1806: (x0,x1) => { x0.onerror = x1 },
      _2179: (x0,x1) => { x0.src = x1 },
      _2190: x0 => x0.width,
      _2192: x0 => x0.height,
      _2676: (x0,x1) => { x0.accept = x1 },
      _2690: x0 => x0.files,
      _2716: (x0,x1) => { x0.multiple = x1 },
      _2734: (x0,x1) => { x0.type = x1 },
      _3028: x0 => x0.width,
      _3029: (x0,x1) => { x0.width = x1 },
      _3030: x0 => x0.height,
      _3031: (x0,x1) => { x0.height = x1 },
      _3452: () => globalThis.window,
      _3515: x0 => x0.navigator,
      _3779: x0 => x0.localStorage,
      _3905: x0 => x0.vendor,
      _4112: x0 => x0.length,
      _6016: x0 => x0.type,
      _6017: x0 => x0.target,
      _6057: x0 => x0.signal,
      _6129: () => globalThis.document,
      _6210: x0 => x0.body,
      _6544: (x0,x1) => { x0.id = x1 },
      _7890: x0 => x0.value,
      _7892: x0 => x0.done,
      _8072: x0 => x0.size,
      _8073: x0 => x0.type,
      _8080: x0 => x0.name,
      _8081: x0 => x0.lastModified,
      _8086: x0 => x0.length,
      _8092: x0 => x0.result,
      _8589: x0 => x0.url,
      _8591: x0 => x0.status,
